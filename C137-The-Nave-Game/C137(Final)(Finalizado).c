...
int jogo(){
	int direcao,tecla=32,pos=(j/2),cont,cont2,cdtiro=0,cdinimigo=2,posicao,velocidadeinimigo=10,pontuacao=0,level=1,aumento=0,aumentoapa=0;
	tiro bala[10];
	naveini inimigo[20];
...
void start(){  
	...
	printf("\n\n\nOBS: Coloque em tela cheia antes de iniciar");
